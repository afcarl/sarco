...
from models import CNN4Layers, CNN3Layers, CNN2Layers, theano_fns
...
def mm2px(x, train_y, train_ymm):
    px = x * train_y[0] / train_ymm[0]
...
if __name__ == "__main__":
    ...
    X, y = dataset["X_valid"].get_value(), dataset["y_valid"].get_value()
    ...
    img = tile_raster_images(X, (cropsize, cropsize), (11, 11), (100, 0))
    Im.fromarray(img).save("predictions.jpg") 
